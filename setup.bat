@echo off
echo Setting up "Import to Google Calendar" with icon...
...
reg add "HKCU\Software\Classes\SystemFileAssociations\.ics\shell\ImportToGoogleCalendar" /v Icon /d "%ICON_PATH%" /f
